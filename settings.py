...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(base_path, 'db', 'dev.sqlite3'),
        'USER': '',
        'PASSWORD': '',
        'HOST': '',
        'PORT': '',
...
SECRET_KEY = 's&@6j&r-b8kvdid_b6^*&3)=s$@_to9p+*q&i!d=@1+8s$$ma='
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'openreader.publication.context_processors.get_variables'
)

MIDDLEWARE_CLASSES = (
    'openreader.publication.middleware.PublicationMiddleware', # first in, last out
...
AUTH_PROFILE_MODULE = 'membership.Profile'
